        ...
        <div id="accountDetails">
            ...
            <div style="margin:1% 10% 0 10%;">
                <span class="inputClass">
                    Current Password:
                    <input type="password" placeholder="Enter Current Password" name="currentPassword" id="currentPassword" class="inputClass" required>
                    New Password:
                    <input type="password" placeholder="Enter New Password" name="newPassword" id="newPassword" class="inputClass" required>
                    Retype New Password:
                    <input type="password" placeholder="Re-type New Password" name="reNewPassword" id="reNewPassword" class="inputClass" required>
                </span>
            </div>
            <hr class="borderBottom">
