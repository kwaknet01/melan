...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-120447336-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-120447336-1');
</script>
...
<div class="col-xl-6 col-lg-6 col-md-4 col-sm-4 col-12 containerword text-center" width="50%">
  <br><h2><strong>Personal Tutorial You'll Love</strong></h2>
  <p class="intro"><em>An easy to learn that will fulfill all your corporate training needs.</em></p>
